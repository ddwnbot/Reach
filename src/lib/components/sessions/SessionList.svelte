		...
		<div class="sessions-scroll">
			{#if ungroupedSessions.length > 0}
				...
				>
					...
					<div class="folder-content" ondragover={(e) => { e.preventDefault(); }} ondrop={(e) => moveSessionTo(null)}
					>
			...
			{#each sortedFolders as folder (folder.id)}
				...
				>
					...
					{#if !folderCollapse[folder.id]}
						<div class="folder-content" ondragover={(e) => { e.preventDefault(); }} ondrop={(e) => moveSessionTo(folder.id)}
						>
